...
int main(int argc,char* argv[])
{
   ...
   glutCreateWindow("Michael Crozier HW5: Spooky Scary BONE TEXTURE");
   //  Set callbacks
   ...
   glutIdleFunc(idle);
   //  Load textures
   texture[0] = LoadTexBMP("bone2.bmp");
   texture[1] = LoadTexBMP("bone3.bmp");
   texture[2] = LoadTexBMP("bone4.bmp");
   texture[3] = LoadTexBMP("bone5.bmp");
